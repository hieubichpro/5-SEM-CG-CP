...
{
    public:
    Camera(float width, float height, Vec3f pos = {0, 0, -7}, Vec3f up = {0, 1, 0}, Vec3f target = {0, 0, 1},
    ...
    {
        auto normal = Vec3f::cross(target, up);
        target = rotateQautr(normal, target, angle);
