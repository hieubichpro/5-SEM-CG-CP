...
//    void on_test_clicked();
    ...
    void on_intensity_valueChanged(double param);
    void on_ambient_valueChanged(double param);
    void on_diffuse_valueChanged(double param);
    void on_specular_valueChanged(double param);
    void on_alpha_valueChanged(double param);
